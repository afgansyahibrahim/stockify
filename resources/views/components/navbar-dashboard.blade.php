            ...
            <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
              ...
              <div class="grid grid-cols-3 gap-4 p-4">
                ...
                <form action="{{ route('logout') }}" method="POST">
                  ...
                  <button type="submit"
                      class="block w-full rounded-lg p-4 text-center hover:bg-gray-100 dark:hover:bg-gray-600">
                      <svg class="mx-auto mb-1 h-7 w-7 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
